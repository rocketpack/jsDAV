...
exports.jsDAV_Exception_Locked = function(lock) {
	exports.jsDAV_Exception.call(this);
    this.code = 423;
...
require('util').inherits(exports.jsDAV_Exception_Locked, exports.jsDAV_Exception);
...
require('util').inherits(exports.jsDAV_Exception_LockTokenMatchesRequestUri, exports.jsDAV_Exception);
